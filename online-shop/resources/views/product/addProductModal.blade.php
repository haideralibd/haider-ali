            ...
            <div class="modal-content">
                ...
                <div class="modal-body mx-3">
                    ...
                    <div class="md-form mb-5">
                        ...
                        <select name="category" id="category" class="form-control" onchange="find_sub_category()">
                            <option value="">Select
                            </option>
                            <option value=1>Book
                            </option>
                    ...
                    <div class="md-form mb-5">
                        ...
                        <select name="subcategory" id="subcategory" class="form-control" onchange="find_sub_category()">
                            <option value="">Select
                            </option>
                            <option value=1>Book
                            </option>
                    ...
                    <div class="md-form">
                        ...
                        <textarea type="text" name="description" id="description" class="md-textarea form-control" rows="4"></textarea>
                    </div>
